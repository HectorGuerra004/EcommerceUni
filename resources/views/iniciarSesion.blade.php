        ...
        <main class="flex-grow bg-[url('http://127.0.0.1:8000/storage/img/computadoras.jpg')] bg-cover bg-center">
            <div class="flex flex-col items-center justify-center my-25 mx-5 dark">
                <div class="w-full max-w-md bg-gray-800 rounded-lg shadow-md p-6">
                    <h2 class="!text-2xl !font-bold text-center !text-gray-200 !mb-4">Iniciar Sesion</h2>
                    @if ($errors->any())
                    ...
                    @endif
                    <form class="flex flex-wrap" method="POST" action="{{ route('login.submit') }}">
                        @csrf
                        ...
                        <button type="submit"
                            class="!bg-gradient-to-r !mx-auto !from-indigo-500 !to-blue-500 !text-white !font-bold !py-2 !px-4 !rounded-md !mt-4 !hover:bg-indigo-600 !hover:to-blue-600 !transition !ease-in-out !duration-150">
                            Iniciar Sesion
                        </button>
                    </form>
                </div>
