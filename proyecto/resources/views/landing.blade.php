...
<body>
    ...
    <div class="mt-2 mb-2">
        ...
        <p class="flex justify-center text-5xl font-bold ">Productos Recomendados</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 ml-2 mr-2">
        <div class="h-48 md:h-[32rem] bg-gray-200 overflow-hidden relative group rounded-sm">
            ...
            <p class="absolute inset-0 flex items-center justify-center text-white text-xl font-bold bg-black/30 z-10">
                Playstation 5
            </p>
        </div>
        <div class="h-48 md:h-[32rem] bg-gray-200 overflow-hidden relative group rounded-sm">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-10 p-6 bg-blue-500 justify-center">
        <div class="justify-center p-8">
            <p class="text-center text-white text-xl md:text-2xl lg:text-3xl font-bold leading-tight uppercase">Compra
                sin moverte</p>
            <p class="text-white">
                <br>Encuentra lo que necesitas, y coordina el pago y la entrega con el vendedor. Es fácil y rápido.
                ¡Todos podemos hacerlo!
            </p>
        </div>
        <div class="justify-center p-8">
            <p class="text-center text-white text-xl md:text-2xl lg:text-3xl font-bold leading-tight uppercase">Recibe
                tu producto </p><br>
            <p class="text-white">
                Acuerda la entrega de tu compra con el vendedor. Puedes recibirlo en tu casa, en la oficina o retirarlo.
        ...
        <div class="justify-center p-8">
            <p class="text-center text-white text-xl md:text-2xl lg:text-3xl font-bold leading-tight uppercase">
                TECNOIMPULSO</p><br>
            <p class="text-white">
                Descubre herramientas para gaming, trabajo y entretenimiento. Conecta con lo último en PCs, consolas y
