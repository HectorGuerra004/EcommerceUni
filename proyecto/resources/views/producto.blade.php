            ...
            <div class="flex justify-center flex-col md:flex-row md:px-[200px] md:py-[100px] relative bg-gray-200">
                ...
                <div class="description max-w-[80vh] p-6 md:py-[40px] mx-4">
                    ...
                    <div class="buttons-container flex flex-col md:flex-row mt-8">
                        ...
                        @auth
                            <div class="mt-8">
                                @livewire('add-to-cart-button', ['producto' => $producto], key($producto->id))
                            </div>
                        @else
                            <div class="mt-8">
                                <a href="{{ route('iniciarSesion') }}"
                                    class="btn border-none rounded-lg w-full bg-amber-600 text-white font-[700] px-[70px] py-3 md:py-2 md:text-[14px] transition-all shadow-lg shadow-amber-600/50 hover:opacity-50 cursor-pointer block text-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="mr-2 h-6 w-6 inline" fill="none"
